...
--				print("bestzone", table_to_str(best_zones), best, "going to", next_zone)
				go("get cellar wines", next_zone, macro_noodleserpent, {}, { "Spirit of Bacon Grease", "Fat Leon's Phat Loot Lyric", "The Ballad of Richie Thingfinder", "Chorale of Companionship", "Heavy Petting", "Peeled Eyeballs", "Leash of Linguini", "Empathy" }, "Slimeling", 50)
			end
		end
	end
...
-- 			pyramid4_5.gif -> turn
	...
	function f.do_filthworms()
		...
		elseif buff("Filthworm Drone Stench") then
			...
			go("fight guard", 129, (challenge == "boris" and have_item("peppermint crook") and macro_softcore_boris_crook) or macro_ppnoodlecannon, {}, { "Spirit of Bacon Grease", "Fat Leon's Phat Loot Lyric", "The Ballad of Richie Thingfinder", "Chorale of Companionship", "Heavy Petting", "Peeled Eyeballs", "Leash of Linguini", "Empathy" }, "Slimeling", 30, { equipment = { familiarequip = "sugar shield", pants = (challenge == "boris" and have("Greatest American Pants")) and "Greatest American Pants" or nil } })
		...
		elseif buff("Filthworm Larva Stench") then
			...
			go("fight drone", 128, (challenge == "boris" and count_item("peppermint crook") >= 2 and macro_softcore_boris_crook) or macro_ppnoodlecannon, {}, { "Spirit of Bacon Grease", "Fat Leon's Phat Loot Lyric", "The Ballad of Richie Thingfinder", "Chorale of Companionship", "Heavy Petting", "Peeled Eyeballs", "Leash of Linguini", "Empathy" }, "Slimeling", 30, { equipment = { familiarequip = "sugar shield", pants = (challenge == "boris" and have("Greatest American Pants")) and "Greatest American Pants" or nil } })
		elseif have("filthworm hatchling scent gland") then
			...
			go("fight hatchling", 127, (challenge == "boris" and count("peppermint crook") >= 3 and macro_softcore_boris_crook) or macro_ppnoodlecannon, {}, { "Spirit of Bacon Grease", "Fat Leon's Phat Loot Lyric", "The Ballad of Richie Thingfinder", "Chorale of Companionship", "Heavy Petting", "Peeled Eyeballs", "Leash of Linguini", "Empathy" }, "Slimeling", 30, { equipment = { familiarequip = "sugar shield", pants = (challenge == "boris" and have("Greatest American Pants")) and "Greatest American Pants" or nil } })
		end
	end
	...
	function f.do_trapper_quest()
		...
		elseif quest_text("gather up some cheese and ore for him") then
			...
			elseif count_item("goat cheese") < 3 then
				...
				local bufftbl = { "Fat Leon's Phat Loot Lyric", "The Ballad of Richie Thingfinder", "Chorale of Companionship", "Leash of Linguini", "Empathy", "Spirit of Garlic" }
...
-- 		print("  mainstat", basemainstat(), "dance cards", count("dance card"), "advs", advs(), "trail turns", buffturns("On the Trail"))
	...
	function f.get_big_book_of_pirate_insults()
		...
		elseif not ascensionstatus("Hardcore") and challenge then
			...
			script.bonus_target { "noncombat", "item" }
			go("get swashbuckling outfit", 66, macro_noodlecannon, {}, { "Smooth Movements", "The Sonata of Sneakiness", "The Ballad of Richie Thingfinder", "Chorale of Companionship", "Fat Leon's Phat Loot Lyric" }, "Slimeling", 25, { choice_function = function(advtitle, choicenum)
...
-- 			end
	...
	function f.make_star_key()
		...
		if got_enough then
			...
			script.bonus_target { "item" }
			go("finish hits", 83, macro_noodlecannon, {}, { "Spirit of Peppermint", "The Ballad of Richie Thingfinder", "Chorale of Companionship", "Fat Leon's Phat Loot Lyric", "Heavy Petting", "Peeled Eyeballs", "Leash of Linguini", "Empathy" }, "Slimeling", 40)
		end
		return result, resulturl, did_action
	end
...
if monstername modern zmobie
  use Rain-Doh black box
		...
		elseif cyrpt:match("Defiled Nook") then
			...
			go("do crypt nook", 264, macro_noodlecannon, noncombattbl, { "Spirit of Garlic", "The Ballad of Richie Thingfinder", "Chorale of Companionship", "Fat Leon's Phat Loot Lyric", "A Few Extra Pounds", "Heavy Petting", "Peeled Eyeballs", "Leash of Linguini", "Empathy" }, "Slimeling", 25)
		else
...
-- 		TODO: more buffs?
		...
		if fullness() + count("hellion cube") * 6 + 6 <= estimate_max_fullness() and ascensionstatus() == "Hardcore" and challenge ~= "zombie" then
			go("getting hellion cubes", 239, make_cannonsniff_macro("Hellion"), nil, { "Smooth Movements", "The Sonata of Sneakiness", "Leash of Linguini", "Empathy", "Butt-Rock Hair", "Spirit of Garlic", "Fat Leon's Phat Loot Lyric", "The Ballad of Richie Thingfinder", "Chorale of Companionship",  "A Few Extra Pounds" }, "Slimeling", 20, { olfact = "Hellion" })
	...
	function f.do_oasis_and_desert()
		...
		elseif quest_text("tasked you with finding a stone rose") then
			...
			if not (have("stone rose") and have("drum machine")) then
				...
				script.bonus_target { "item" }
				go("get stone rose + drum machine", 122, macro_noodleserpent, nil, { "Fat Leon's Phat Loot Lyric", "The Ballad of Richie Thingfinder", "Chorale of Companionship", "Spirit of Bacon Grease" }, "Slimeling", 60)
	...
	function f.do_never_odd_or_even_quest()
		if not have("Talisman o' Nam") then
			if not have("pirate fledges") then
				...
				}, { "Musk of the Moose", "The Ballad of Richie Thingfinder", "Chorale of Companionship", "Fat Leon's Phat Loot Lyric", "Spirit of Bacon Grease", "Heavy Petting", "Peeled Eyeballs", "Leash of Linguini", "Empathy" }, "Jumpsuited Hound Dog", 40, { equipment = { hat = "eyepatch", pants = "swashbuckling pants", acc3 = "stuffed shoulder parrot" } })
